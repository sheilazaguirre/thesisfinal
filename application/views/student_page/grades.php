<?php
	...
	WHERE g.studentID = $_SESSION[userIDNo] AND c.semester = '1st' AND c.academicYear=YEAR(NOW())");
	...
	INNER JOIN classes c ON c.classID = g.classID 
	WHERE g.studentID = $_SESSION[userIDNo] AND c.semester = '2nd' AND c.academicYear=YEAR(NOW())");
