<?php
    ...
    WHERE u.userIDNo = $_SESSION[userIDNo] AND a.status = 'Active' AND c.semester='1st' AND c.academicYear=YEAR(NOW())");
    ...
    INNER JOIN subjects s ON c.subjectID = s.subjectID 
    INNER JOIN users u ON cl.studentID = u.userIDNo 
    WHERE u.userIDNo = $_SESSION[userIDNo] AND a.status = 'Active' AND c.semester='2nd' AND c.academicYear=YEAR(NOW())");
