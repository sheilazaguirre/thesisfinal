<?php
    ...
    WHERE c.facultyID = $_SESSION[userIDNo] AND l.status = 'Active' AND c.semester='1st' AND c.academicYear=YEAR(NOW())");
    ...
    INNER JOIN classes c ON l.classID = c.classID 
    INNER JOIN subjects s ON c.subjectID = s.subjectID 
    WHERE c.facultyID = $_SESSION[userIDNo] AND l.status = 'Active' AND c.semester='2nd' AND c.academicYear=YEAR(NOW())");
?>
<!DOCTYPE html>
<html>
    <head>
