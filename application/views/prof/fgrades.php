<?php
	...
	$result9 = mysqli_query($db, "SELECT COUNT(*), fgrade FROM grades WHERE fgrade='5' AND classID='".$classID."'");
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<select name="fgrade[<?=$c['classlistID']?>]" <?php if ($c['status'] == 'FSubmitted'){ ?> disabled <?php   } ?> required />
