<?php
	...
	WHERE c.facultyID= $_SESSION[userIDNo] AND c.status='Active' AND c.semester = '1st' AND c.academicYear=YEAR(NOW())");
	...
	INNER JOIN timeslots t ON c.timeSlotID = t.timeSlotID 
	INNER JOIN venues v ON c.venueID = v.venueID 
	WHERE u.userIDNo= $_SESSION[userIDNo] AND c.status = 'Active' AND c.semester = '2nd' AND c.academicYear=YEAR(NOW())");
