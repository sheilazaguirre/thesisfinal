...
<head>
  ...
  <link rel="shortcut icon" href="../resources/my-images/gapc-favicon.ico">
	...
	<title>Flow Chart - BS Computer Science</title>
	<style>
.content {
    max-width: 690px;
    margin: auto;
