...
<head>
  ...
  <link rel="shortcut icon" href="../resources/my-images/gapc-favicon.ico">
	...
	<title>Flow Chart - Secondary Education: Mathematics</title>
	<style>
.content {
    max-width: 690px;
    margin: auto;
